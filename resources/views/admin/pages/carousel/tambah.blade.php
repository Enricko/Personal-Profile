        ...
        <div class="row">
            <div class="col-md-7">
                <div class="p-5">
                    ...
                    <form class="user" action="/carousel/insert" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="sub_title" required="" id="sub_title"
